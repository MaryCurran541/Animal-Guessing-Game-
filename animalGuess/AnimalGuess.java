...
/*
 * Mary Curran Computer Science 3 Assignment 15
 * 
 * program using binary tree to guess the animal
 * 
 * @author Mary Curran
 * @since 11/4/2021
 * @version 1.0
   ...
   **/
   public static BTNode<String> beginningTree( )   
   {
	   BTNode<String> root;
	      ...
	      // Create and attach the left subtree. "Are you bigger than a cat?"
	      ...
	      // Create and attach the right subtree. "Do you live underwater?"
	...
	// Added a left subtree to first left subtree "Are you a marsupial?"
	 ...
	 // Added a left subtree to the first right subtree "Are you a vertebrate?"
	...
	// Added a right subtree to the first right subtree "Can you fly?"
